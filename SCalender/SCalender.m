...
#import "SCalender.h"
#import "SCalenderItem.h"

#define Weekdays @[@"日", @"一", @"二", @"三", @"四", @"五", @"六"]

static NSDateFormatter *dateFormattor;

@interface SCalender ()<UIScrollViewDelegate, SCalendarItemDelegate>
@property (strong, nonatomic) NSDate *date;

@property (strong, nonatomic) UIButton *titleButton;
@property (strong, nonatomic) UIScrollView *scrollView;
@property (strong, nonatomic) SCalenderItem *leftCalendarItem;
@property (strong, nonatomic) SCalenderItem *centerCalendarItem;
@property (strong, nonatomic) SCalenderItem *rightCalendarItem;
@property (strong, nonatomic) UIView *backgroundView;
@property (strong, nonatomic) UIView *datePickerView;
@property (strong, nonatomic) UIDatePicker *datePicker;
@end

@implementation SCalender
...
- (void)setupWeekHeader {
    ...
    for (int i = 0; i < count; i++) {
        UILabel *weekdayLabel = [[UILabel alloc] initWithFrame:CGRectMake(offsetX, 50, (DeviceWidth - 10) / count, 40)];
...
- (void)setupCalendarItems {
    ...
    self.leftCalendarItem = [[SCalenderItem alloc] init];
    ...
    self.centerCalendarItem = [[SCalenderItem alloc] init];
    ...
    self.rightCalendarItem = [[SCalenderItem alloc] init];
