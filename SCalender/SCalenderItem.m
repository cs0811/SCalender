...
@interface SCalendarCell : UICollectionViewCell
...
@interface SCalenderItem () <UICollectionViewDataSource, UICollectionViewDelegate>

@property (strong, nonatomic) UICollectionView *collectionView;

@end

@implementation SCalenderItem
...
- (void)setupCollectionView {
    ...
    [self.collectionView registerClass:[SCalendarCell class] forCellWithReuseIdentifier:@"CalendarCell"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SCalendarCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
